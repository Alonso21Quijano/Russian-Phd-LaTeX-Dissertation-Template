...
\subsection{Уровень 0. Отсутствие автоматизации}

На данном уровне водитель полностью контролирует движение транспортного средства. Рулевое управление, ускорение, торможение и выполнение маневров осуществляется исключительно человеком. Автоматические системы, доступные на транспортных средствах данного уровня, осуществляют только информационные функции либо единовременно берут на себя управление транспортным средством. Примерами систем такого уровня являются системы обнаружения съезда с полосы движения, системы обнаружения объектов в слепых зонах транспортного средства, системы экстренного торможения и др.

\section{Модели окружающего пространства робота}\label{sec:ch1/sec2}
...
\subsection{Метрика оценки качества карты проходимости пространства $PFC-MSE$}\label{sec:ch1/sec5.1}
