...
К настоящему моменту предложено множество моделей окружающего пространства. Их можно классифицировать по трём категориям:
...
\section{Классификация методов комплексирования данных}\label{sec:ch1/sec4}

\section{Требования к алгоритму картографирования окружающего пространства робота}\label{sec:ch1/sec5}
